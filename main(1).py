...
path = 'dataset' #FOLDER NAME
images = [] #LOAD IMAGES
classNames = [] # STUDENT NAME

for file in os.listdir(path): # SPLIT THE EXTENSION AND APPEND IN CLASS NAME
...
cap = cv2.VideoCapture(0) # ZERO USED FOR WEB CAME OPEN
...
while True:
    ...
    encodesCurFrame = face_recognition.face_encodings(imgSmall, facesCurFrame) # COMPARE THE IMAGE WITH CAMERA IMAGE
